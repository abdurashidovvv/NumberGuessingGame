...
class MainViewModel : ViewModel() {
    ...
    fun onUserInput(userNumber: String, context: Context) {
        ...
        if (userNumberInInt !in 0..100) {
            Toast.makeText(context, "Please enter a number between 0 and 100.", Toast.LENGTH_SHORT)
                .show()
            return
        }
        ...
        val newGuessLeft = currentState.noOfGuessLeft.minus(1)
